...
import { JunoListLogo } from '../assets'
            ...
            >
              ...
              <input
                ...
                className={classNames(
                  ...
                  ' placeholder-gray-400 pr-6 break-words border-0 p-0 m-0 focus:ring-transparent w-full resize-none outline-none'
                )}
